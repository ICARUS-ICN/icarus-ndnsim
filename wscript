...
def build(bld):
    ...
    module.source = [
        ...
        'model/ground-node-sat-tracker-elevation.cc',
        'model/ground-node-sat-tracker-periodic.cc',
    ...
    headers.source = [
        ...
        'model/ground-node-sat-tracker-elevation.h',
        'model/ground-node-sat-tracker-periodic.h',
