...
NS_LOG_COMPONENT_DEFINE ("icarus.Ground2GroundPconExample");
...
main (int argc, char **argv) -> int
{
  ...
  icarusHelper.SetDeviceAttribute("DataRate", DataRateValue(DataRate ("100Mb/s")));
  ISLHelper islHelper;
  islHelper.SetDeviceAttribute("DataRate", DataRateValue(DataRate ("100Mb/s")));
  ...
  ndn::L3RateTracer::Install (ground1, fileTrace, Seconds (3600));
